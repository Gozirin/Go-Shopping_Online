...
public class BoissonsAdapter extends RecyclerView.Adapter<BoissonsAdapter.ViewHolder> {

    private Context context;
    private List<PostBoissons> posts;

    public BoissonsAdapter(Context context, List<PostBoissons> posts) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        PostBoissons postBoissons = posts.get(position);
        holder.bind(postBoissons);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(PostBoissons post) {
