...
public class AMenagersAdapter extends RecyclerView.Adapter<AMenagersAdapter.ViewHolder> {

    private Context context;
    private List<PostAMenagers> posts;

    public AMenagersAdapter(Context context, List<PostAMenagers> posts) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        PostAMenagers postAMenagers = posts.get(position);
        holder.bind(postAMenagers);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(PostAMenagers post) {
